...
def main():
    parser = argparse.ArgumentParser(description="Data augmentation using Google AI")
    parser.add_argument("--input_dir", "-i", help="Directory containing JSON files", required=True)
    parser.add_argument("--gold", "-g", help="Gold file with classifications", required=True)
    parser.add_argument("--output_dir_0", "-o0", help="Output directory for class 0", default="clase_0")
    parser.add_argument("--output_dir_1", "-o1", help="Output directory for class 1", default="clase_1")
...
def modificado_auxiliar():
    ...
    Parámetros:
        dir_clase_0: Carpeta con los archivos de clase 0
        dir_clase_1: Carpeta con los archivos de clase 1
        output_file: Ruta del archivo de salida a crear
    """
    parser = argparse.ArgumentParser(description="Data augmentation using Google AI")
    parser.add_argument("--gold", "-g", help="Gold file with classifications", required=True)
    parser.add_argument("--output_dir_0", "-o0", help="Output directory for class 0", default="clase_0")
